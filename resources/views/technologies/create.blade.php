...
<head>
    ...
    <title>Pierre Mauriello - Add a techno</title>
    <style>
...
<table class="border">
    <tr class="border">techno</tr>
    @foreach($technologies as $technology)

        <td class="border">
            {{$technology->TechnoName}}
        </td>
    @endforeach
</table>
</main>
